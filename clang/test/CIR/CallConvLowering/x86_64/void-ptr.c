...
// Test void pointer support (exercises VoidType handling in CIRLowerContext and LowerTypes).
// NOTE: Vector types are NYI in X86 ABI classification, so we only test void pointers here.
